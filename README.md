...
I'm a Full Stack .NET developer based in Stockholm with a background in engineering mechanics and mathematical modelling. I care about writing clean, maintainable code and building systems that are thoughtfully designed.

Most recently I worked at **Antirio**, contributing to the modernization of a procurement and contract management platform from legacy ASP.NET Web Forms to ASP.NET Core - incrementally and without disrupting the live service.
...
![NHibernate](https://img.shields.io/badge/NHibernate-888888?style=for-the-badge)
